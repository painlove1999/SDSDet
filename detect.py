...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/SMOD-YOLO.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'C:\Users\佩恩love\Desktop\人工智能比赛\202209300903_Trim.mp4', help='file/dir/URL/glob, 0 for webcam')
    # parser.add_argument('--source', type=str, default=r'data/images', help='file/dir/URL/glob, 0 for webcam')
    ...
    # parser.add_argument('--visualize_kernal', action='store_true', default=False, help='visualize kernal')
