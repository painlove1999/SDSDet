...
class TFBottleneck(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5, w=None):  # ch_in, ch_out, shortcut, groups, expansion
        ...
        self.cv2 = TFConv(c_, c2, 3, 1, g=g, w=w.cls_preds)
...
class TFBottleneckCSP(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, w=None):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = TFConv(c1, c_, 1, 1, w=w.cv1)
        self.cv2 = TFConv2d(c1, c_, 1, 1, bias=False, w=w.cls_preds)
...
class TFC3(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, w=None):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = TFConv(c1, c_, 1, 1, w=w.cv1)
        self.cv2 = TFConv(c1, c_, 1, 1, w=w.cls_preds)
...
class TFSPP(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, k=(5, 9, 13), w=None):
        ...
        self.cv1 = TFConv(c1, c_, 1, 1, w=w.cv1)
        self.cv2 = TFConv(c_ * (len(k) + 1), c2, 1, 1, w=w.cls_preds)
...
class TFSPPF(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, k=5, w=None):
        ...
        c_ = c1 // 2  # hidden channels
        self.cv1 = TFConv(c1, c_, 1, 1, w=w.cv1)
        self.cv2 = TFConv(c_ * 4, c2, 1, 1, w=w.cls_preds)
